...
<body>
    ...
    <?php else: ?>
            ...
            <div class="container">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <span class="me-3 text-secondary"><?php echo e(Auth::user()->email); ?></span>
        ...
        <footer>
            &copy; <?php echo e(date('Y')); ?> Toko Makanan Modern &mdash; Built with Laravel & Bootstrap
        </footer>
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\uas_laravel-main\resources\views/layout.blade.php ENDPATH**/ ?>